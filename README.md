...
3. Run these commands to install node and npm `brew install node; brew install npm`. 

### Final Installation Steps

Open your favorite application: Terminal on Mac OS or Command Prompt or Powershell on Windows.

#### Git
We need to install Git. On Mac, you need to write:
`git --version`. If it's installed, you'll get a version number. If not, you'll be prompted to do so. Click yes.

On Windows, 

2. Clone the repository to your computer with this command: `git clone https://github.com/garrett-laroy-johnson/chaosmotic-systems-wiki`
3. Run the command: `cd chaosmotic-systems-wiki`
4. Run the command (that means type and hit enter): npm i. This will install all the requisate files to build out the site from our Obsidian files. You are ready.
